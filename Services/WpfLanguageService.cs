...
public sealed class WpfLanguageService : ILanguageService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishToTurkish =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Drag ends · Shift for straight lines"] = "Uçları sürükleyin · Düz çizgi için Shift",
            ["Check for _updates…"] = "_Güncellemeleri denetle…",
            ["Checking for updates…"] = "Güncellemeler denetleniyor…",
            ["An update is available"] = "Yeni bir güncelleme mevcut",
            ["Update check complete"] = "Güncelleme denetimi tamamlandı",
            ["Update checking is unavailable"] = "Güncelleme denetimi kullanılamıyor",
            ["Could not check for updates. Check your internet connection or try again later."] = "Güncellemeler denetlenemedi. İnternet bağlantınızı kontrol edin veya daha sonra tekrar deneyin.",
